/-
Papers/P27_LLPOBell/Basic.lean
Paper 27: The Logical Cost of Root-Finding
Basic.lean — Omniscience principle definitions and hierarchy

Defines LLPO (Lesser Limited Principle of Omniscience) and re-declares
LPO, WLPO as standalone definitions. Paper 27 is a self-contained bundle.
...
/-- Lesser Limited Principle of Omniscience.
    ...
    Ishihara 1989). Strictly between BISH and WLPO. -/
def LLPO : Prop :=

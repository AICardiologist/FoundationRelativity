...
\midrule
FLT (Wiles--Taylor) & $\BISH$ & $\WKL$ & Paper~68 \\
...
\textbf{Theorem} & \textbf{Classical tool}
  ...
  & \textbf{Gap} \\
\midrule
FLT & Modularity lifting & $\BISH$ & $\WKL$ & 2 levels \\
...
is $\BISH$ (zero gap); Paper~68 showed FLT is $\WKL$ (two-level
...
\bibitem{lee-p68}
P.~C.-K.~Lee.
\textit{The Logical Cost of Fermat's Last Theorem
(Paper~68, CRM Series)}.
Zenodo, 2025.

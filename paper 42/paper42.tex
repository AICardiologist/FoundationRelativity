...
\textbf{Paper 39 (Physical Stratification)~\cite{Lee26P39}:}\quad
By Paper~39's stratification theorem, the \emph{epistemic mode}
(exact vs promise-gapped vs empirical)---not thermodynamic scaling
(extensive vs intensive)---determines the arithmetic level.
Exact observables without promise gap reach $\Sigma_2^0$ ($\LPO'$);
promise-gapped and empirical observables cap at $\LPO$.
The CC problem stays at $\LPO$ because all relevant
quantities---energy densities, condensates---are measured at finite
precision, enforcing an effective promise gap.
...
\bibitem{Lee26P39}
P.~C.-K.~Lee,
``Physics reaches $\Sigma_2^0$: the physical stratification of undecidability,''

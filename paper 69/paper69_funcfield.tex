...
Last Theorem, establishing $\CRM(\text{FLT}) = \WKL$ (Taylor--Wiles patching) while showing that
Wiles's 1995 proof route costs $\WKL + \WLPO$. The $\WLPO$ entered through
...
mathematical arguments supporting the component-cost assignments have been
...
\bibitem{Paper68}
P.~C.-K.~Lee,
\emph{The Logical Cost of Fermat's Last Theorem},

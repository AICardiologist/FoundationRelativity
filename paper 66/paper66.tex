...
This paper was produced with AI assistance (Anthropic Claude) for
computation and manuscript preparation.  The author is not a
domain expert in algebraic number theory; all claims are supported
by exact computation or explicit proof.  The CRM program builds on
foundational work of Bishop \cite{bishop67}, Bridges--Richman
\cite{bridges_richman87}, and the Mathlib community.

...
**Domain-expert disclaimer.** The formal verification confirms logical
correctness of the stated theorems relative to their axioms. The physical
modeling assumptions (one-loop approximation, Standard Model fermion content,
lattice QCD setup, Yang-Mills gap conjectures) require domain expertise in
quantum chromodynamics the author does not claim expertise in these areas and therefore this work is preliminary. The author
is a medical professional who received substantial AI assistance; these
results should be considered preliminary pending domain-expert review.
...
Lean/P33_QCDConfinement/               Lean 4 formalization

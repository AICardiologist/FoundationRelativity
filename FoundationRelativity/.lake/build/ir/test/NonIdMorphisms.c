...
// Module: test.NonIdMorphisms
// Imports: Init Gap2.Functor APFunctor.Functor RNPFunctor.Functor Found.InterpCore
#include <lean/lean.h>
...
{
lean_object* x_1; 
x_1 = lean_mk_string_from_bytes("✓ All functors are properly covariant and handle non-identity morphisms", 73);
return x_1;
}
}
...
LEAN_EXPORT lean_object* initialize_test_NonIdMorphisms(uint8_t builtin, lean_object* w) {
lean_object * res;
...
res = initialize_test_NonIdMorphisms(1 /* builtin */, lean_io_mk_world());

...
// Module: test.Gap2MigrationTest
// Imports: Init Gap2.Functor Found.WitnessCore
#include <lean/lean.h>
...
{
lean_object* x_1; 
x_1 = lean_mk_string_from_bytes("✓ Gap₂ successfully migrated to WitnessCore API", 51);
return x_1;
}
}
...
LEAN_EXPORT lean_object* initialize_test_Gap2MigrationTest(uint8_t builtin, lean_object* w) {
lean_object * res;
...
res = initialize_test_Gap2MigrationTest(1 /* builtin */, lean_io_mk_world());

...
{
lean_object* x_1; 
x_1 = lean_mk_string_from_bytes("✓ Witness API tests pass", 26);
return x_1;
}
}
...
LEAN_EXPORT lean_object* initialize_test_WitnessTest(uint8_t builtin, lean_object* w) {
lean_object * res;
...
res = initialize_test_WitnessTest(1 /* builtin */, lean_io_mk_world());

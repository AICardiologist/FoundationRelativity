...
% ---------- Lean repo link ----------
\newcommand{\leanRepo}{\url{https://doi.org/10.5281/zenodo.18838541}}
...
the \emph{theorem}.  Geometric modularity ($E \sim A_f$,
requiring Faltings) remains~$\CLASS$, but FLT needs only Galois
modularity ($\rho_{E,p} \cong \rho_{f,p}$).
The CRM programme thesis---that logical

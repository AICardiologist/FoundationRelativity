/-
Papers/P9_Combinatorial_Ising/PartB_Defs.lean
...
/-- Free energy at coupling J: g(J) = -log(2·cosh(β·J)).
    ...
    with uniform coupling J. Derived combinatorially via the partition function
    identity Z_N(β,J) = (2·cosh(βJ))^N + (2·sinh(βJ))^N (Lemma 5.0). -/

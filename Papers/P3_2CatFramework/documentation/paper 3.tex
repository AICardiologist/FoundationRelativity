...
The Baire Category Theorem (\BCT{}) is particularly crucial for operator theory. In $\mathsf{ZF}$, \BCT{} is \emph{equivalent} to \DCo{} (see Blair~1977). This motivates our third calibration axis:
...
BCT $\leftrightarrow$ \DCo{} (in ZF) & Blair 1977 & Reverse direction \\

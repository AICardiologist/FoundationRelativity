...
% --- Reproducibility macros (Paper 3B)
\providecommand{\leanRepo}{\url{https://github.com/AICardiologist/FoundationRelativity}}
\providecommand{\pThreeBTag}{p3b-collisions-v0.1} % set to your GitHub release tag
\providecommand{\pThreeBDOI}{10.5281/zenodo.TBD}  % replace after Zenodo mints DOI
...
\begin{itemize}
  ...
  \item \textbf{Witness modules}: 
    \texttt{P4\_Meta/Meta\_Ladders.lean} (ladder infrastructure),
    \texttt{P4\_Meta/IndependenceRegistry.lean} (axiom registry),
    \texttt{P4\_Meta/PartV\_Collision.lean} (RFN $\Rightarrow$ Con theorem).

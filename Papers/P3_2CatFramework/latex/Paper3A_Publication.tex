...
The Baire Category Theorem (\BCT{}) is particularly crucial for operator theory. In $\mathsf{ZF}$, \BCT{} is \emph{equivalent} to \DCw{} (see \cite{blair1977axiom}). This motivates our third calibration axis:
...
BCT $\leftrightarrow$ \DCw{} (in ZF) & \cite{blair1977axiom} & Reverse direction \\

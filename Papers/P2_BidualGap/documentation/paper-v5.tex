...
\author{Paul Chun-Kit Lee\thanks{Tooling \& AI disclosure:
Large-language-model programming assistants (e.g., GPT-5 Pro, Gemini, Claude) were used for refactoring, boilerplate generation, and error-message triage in the Lean code, under human supervision. All mathematical statements were authored, reviewed, and interpreted by the author and have been machine-checked in Lean~4; no model is credited as an author. The author takes full responsibility for the content.}\thanks{Lean 4 formalization available at \leanRepo. Code archive: DOI \texttt{10.5281/zenodo.17107493}.} \\ 
New York University \\ 
...
\noindent\textbf{Tooling and AI Use Disclosure.}
This paper used LLM-based programming assistants in the Lean development for routine tasks (refactoring, boilerplate, docstrings, and error-message triage). Conception of the results, choice of definitions, proof strategy, and all mathematical writing are the author's; all claims have been checked in Lean~4 against \emph{mathlib}. No model is listed as an author, and the author remains fully responsible for the content. This disclosure is made up front to comply with emerging community and publisher policies regarding generative AI.
\end{mdframed}
...
\item \textbf{Tooling}: See the front-page Tooling and AI Use Disclosure for a summary of the limited role of LLM tools.
\end{itemize}
\end{mdframed}
...
\smallskip
\noindent\textbf{Tooling note.} The Lean code benefited from standard programming assistants under human supervision; see the front-page disclosure. All results were machine-checked in Lean~4.

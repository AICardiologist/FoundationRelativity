...
% (Theorem environments already defined above)
...
% \thanks{Lean 4 formalization available at \leanRepo. A citable snapshot is archived at Zenodo: DOI \texttt{10.5281/zenodo.13356587}.} % TODO: Replace DOI with actual value
...
\item \textbf{Artifact DOI}: \texttt{10.5281/zenodo.13356587} % TODO: Replace with actual DOI
...
$\BISH+\neg\WLPO$ & \emph{Not derivable in general} & does not imply surjectivity of $J$ \\
\bottomrule
\end{tabular}
\end{center}

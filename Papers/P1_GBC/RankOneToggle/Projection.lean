...
lemma ker_projLine (u : H) (hu : ‖u‖ = 1) :
  ...
  constructor
  · intro hx
    have : (@inner 𝕜 _ _ u x) = 0 := by
      have := congrArg (fun z : H => (@inner 𝕜 _ _ u z)) hx

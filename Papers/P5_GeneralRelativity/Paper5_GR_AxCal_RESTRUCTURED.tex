...
\usepackage{xcolor}
% listings and float packages not available in minimal TinyTeX, using verbatim instead
...
% Simple environment for code blocks (using verbatim since listings not available)
\newenvironment{leancode}{\small\begin{verbatim}}{\end{verbatim}}

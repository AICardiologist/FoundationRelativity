...
lemma deriv_Γ_r_rr
  ...
  simp only [neg_mul, neg_neg, mul_div_assoc]
...
theorem Ricci_φφ_vanishes
  ...
  -- Expand and simplify
  simp [Γ_r_θθ, Γ_r_φφ, Γ_φ_rφ, Γ_φ_θφ, Γ_θ_φφ, Γ_t_tr, Γ_r_rr, Γ_θ_rθ, Γ_φ_rφ, f]

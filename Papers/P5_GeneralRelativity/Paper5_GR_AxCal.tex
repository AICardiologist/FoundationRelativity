...
\end{proposition}
\begin{proof}[Sketch]
Finite symbolic computation of $\Gamma^\alpha_{\mu\nu}$, $R_{\mu\nu}$, and $G_{\mu\nu}$ (cf.\ \cite[§B.4]{Wald1984}); no portals are triggered. \emph{Note:} While the mathematics is constructive, our Lean formalization uses classical \texttt{mathlib}, yielding structural certification rather than formal constructive proof.
\end{proof}

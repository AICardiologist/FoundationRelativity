...
remains open.  Lean~4 formalisation: ${\sim}350$ lines, zero \texttt{sorry}.
\end{abstract}
...
The Lean~4 formalisation uses Mathlib4~\cite{mathlib}.
This paper was drafted with AI assistance (Claude, Anthropic) for
proof search and exposition.  All mathematical content has been verified
by the author.
